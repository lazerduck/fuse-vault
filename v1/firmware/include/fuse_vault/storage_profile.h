...
enum { FV_PERF_SD_READ, FV_PERF_SD_WRITE, FV_PERF_SD_SYNC,
       FV_PERF_VAULT_READ, FV_PERF_VAULT_WRITE, FV_PERF_SELECT, FV_PERF_VERIFY,
       FV_PERF_NONCE, FV_PERF_LAYER_IV, FV_PERF_AES, FV_PERF_CHACHA,
       FV_PERF_ASCON_ENCRYPT, FV_PERF_ASCON_DECRYPT, FV_PERF_COUNT };
