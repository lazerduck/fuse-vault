/* Modified for Fuse Vault, 2026-09-06: clear crypto providers on mode exit. */
/*
...
void fv_pico_object_session_clear(void) {
    file_object_crypto_provider_deinit(&fido_object_crypto_provider);
    file_object_crypto_provider_deinit(&fido_object_legacy_crypto_provider);
    file_object_crypto_provider_deinit(&fido_oath_object_crypto_provider);
    file_object_crypto_provider_deinit(&fido_otp_object_crypto_provider);
    fido_object_crypto_provider_initialized = false;
    fido_object_legacy_crypto_provider_initialized = false;
    fido_oath_object_crypto_provider_initialized = false;
    fido_otp_object_crypto_provider_initialized = false;
}
