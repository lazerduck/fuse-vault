...
add_library(fv_fido_engine STATIC
    ${FV_PICO_ROOT}/port.c
    ...
    ${FV_PICO_ROOT}/../tinycbor/cborencoder.c
    ${FV_PICO_ROOT}/../tinycbor/cborencoder_close_container_checked.c
    ${FV_PICO_ROOT}/../tinycbor/cborparser.c
    ${FV_PICO_ROOT}/../tinycbor/cborparser_dup_string.c
    ${FV_PICO_ROOT}/../tinycbor/cborvalidation.c
)
target_include_directories(fv_fido_engine PRIVATE
...
target_compile_options(fv_fido_engine PRIVATE -ffunction-sections -fdata-sections)
target_link_libraries(fv_fido_engine PUBLIC fv_crypto)
