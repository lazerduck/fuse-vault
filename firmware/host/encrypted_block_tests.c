...
static void setup(fv_encrypted_block_t*e,fv_block_device_t*raw,const fv_volume_master_key_t*k,const uint8_t id[16],uint8_t start){assert(fv_encrypted_block_init(e,raw,k,id,rng,&start));}
...
static void golden(void){
    ...
    static const uint8_t expected_digest[32]={0x1d,0x6d,0xc3,0x5f,0x16,0xae,0x72,0xb2,0x9f,0x8b,0xba,0xd8,0x80,0x01,0x67,0x46,0xa0,0x1d,0x2d,0x84,0xd7,0x0e,0xef,0x15,0x3a,0x19,0x95,0x8e,0xd3,0x7e,0xb6,0xf2};
